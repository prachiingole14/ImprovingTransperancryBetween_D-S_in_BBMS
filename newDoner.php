...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO `donars`(`name`, `Contact_no`, `Blood_grp`, `email`, `password`, `age`, `weight`) VALUES ('$name', '$phone', '$blood_type', '$email', '$password', '$age', '$weight')";
    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1 class="panel-title">Add New Donar</h1>
            </div>
            ...
            <div class="panel-body">
                <form action="" method="post">
                    ...
                    <div class ="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select name="weight">
                                        ...
                                        <option value="51-55">51-55</option>
                                        <option value="56-60">56-60</option>
                                        <option value="61-55">61-65</option>
                    ...
                    <center><button type="submit" class="btn btn-danger">Add New Donar</button></center>
                </form>
            </div>
        </div>
