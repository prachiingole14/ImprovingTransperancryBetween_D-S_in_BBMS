<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $sql = "INSERT INTO `awareness_camps`(`name`, `Contact_no`, `address`, `date_time`) VALUES ('$name', '$contact', '$address', '$date_time')";
...
<html lang="en">
    ...
    <body>  
        <div class="row">
            <div class="col-md-6">
                <img src="images/calendar.png"  style="width:100%; height:550px;">
            </div>

            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading" style="background-color:brown;">
                        <h1 style="text-align:center; color:white; font-weight: bold; background-color:brown;"> Blood Donation Awareness Camp Registeration</h1>
                    </div>
                    ...
                    <div class="panel-body">
                        <form action="<?PHP echo $_SERVER['SCRIPT_NAME'] ?>" method="POST">
                            ...
                            <div class="form-group">
                                <label for="address">Blood Donation Awareness Camp Address:</label>
