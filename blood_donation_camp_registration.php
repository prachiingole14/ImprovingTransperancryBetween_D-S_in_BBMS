<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $sql = "INSERT INTO `blood_donates`(`name`, `Contact_no`, `address`, `date_time`) VALUES ('$name', '$contact', '$address', '$date_time')";
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading" style="background-color:brown;">
                        <h1 style="text-align:center; color:white; font-weight: bold; background-color:brown;"> Blood Donation Camp Registeration</h1>
                    </div>
                    ...
                    <div class="panel-body">
                        <form action="<?PHP echo $_SERVER['SCRIPT_NAME'] ?>" method="POST">
                            ...
                            <div class="form-group">
                                <label for="address">Blood Donation Camp Address:</label>
